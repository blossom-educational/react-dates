	  ...
	  _createClass(OutsideClickHandler, [{
	    ...
	    value: function () {
	      function componentDidMount() {
	        ...
	        this.touchstartHandle = (0, _consolidatedEvents.addEventListener)(document, 'touchstart', this.onOutsideClick, { capture: true });
	      }
	    ...
	    value: function () {
	      function componentWillUnmount() {
	        ...
	        if (this.touchstartHandle) (0, _consolidatedEvents.removeEventListener)(this.touchstartHandle);
	      }
